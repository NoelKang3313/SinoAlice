...
public class MagitekArmor : MonoBehaviour
{
    [SerializeField]
    ...
    void EnemyDead()
    {
        if (gameObject != null && CurrentHP <= 0)
        {
            ...
            StageManager.CharacterSpeeds.Remove(gameObject.GetComponent<MagitekArmor>().Speed);
