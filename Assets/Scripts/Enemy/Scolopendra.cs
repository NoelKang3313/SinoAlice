...
public class Scolopendra : MonoBehaviour
{
    [SerializeField]
    ...
    void EnemyDead()
    {
        if (gameObject != null && CurrentHP <= 0)
        {
            ...
            StageManager.CharacterSpeeds.Remove(gameObject.GetComponent<Scolopendra>().Speed);
